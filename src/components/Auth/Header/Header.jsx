...
export default function Header() {
    ...
    const [stopAnim, setStopAnim] = React.useState(false);

    return (
            <header className={s.header}>
                <div className={s.headerRow}>
                    <h4>Портал пациента</h4>
                    <button className={`${s.rowRightSide} ${anim && s.removeAnim} ${stopAnim && s.stop}`} onMouseLeave={() => { setTimeout(() => setAnim(false), 500); setStopAnim(false) }} onMouseEnter={() => {
                        setAnim(true);
                        setTimeout(() => setStopAnim(true), 500)
                    }}>
